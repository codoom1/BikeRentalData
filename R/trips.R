...
trip_data_dictionary <- function() {
  tibble::tribble(
    ...
    "start_bikeinfra_500m_m_per_km2", "double", "infrastructure", "Bike infrastructure density within 500 meters of the start station, in meters per square kilometer",
    "end_bikeinfra_500m_m_per_km2", "double", "infrastructure", "Bike infrastructure density within 500 meters of the end station, in meters per square kilometer",
    ...
    "start_protected_bikeinfra_500m_m_per_km2", "double", "infrastructure", "Protected bike infrastructure density within 500 meters of the start station, in meters per square kilometer",
    "end_protected_bikeinfra_500m_m_per_km2", "double", "infrastructure", "Protected bike infrastructure density within 500 meters of the end station, in meters per square kilometer",
    ...
    "start_trail_500m_m_per_km2", "double", "infrastructure", "Trail or shared-use path density within 500 meters of the start station, in meters per square kilometer",
    "end_trail_500m_m_per_km2", "double", "infrastructure", "Trail or shared-use path density within 500 meters of the end station, in meters per square kilometer",
